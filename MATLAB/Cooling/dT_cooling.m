function dT = dT_cooling(of, p_c, D_t, axial_distance, radius_vec,l_con, c_star, m_dot_fuel,c_RP1)
...
axial_distance = [axial_distance; x_cnv];
% convergent part
for j = 1:10
    eps_c = (y_cnv(j)/(D_t/2))^2;
    output_c = cea(CEA('problem','rkt','nfz',2,'o/f',of,'sub',eps_c,'case', 'DRY1', ...
