...
\end{itemize}
%additive types, why do we use lpbf (future is bj): description of technique and adv/disadv

%why inconel (temp, corrosion, miscellaneus prop)
%Smaller powder leads to less porosity. This is because larger size powder requires a higher energy density for melting, resulting in more porosity for a specific energy density. More spherical and less irregular powders create less porosity because of better flowability and less surface contamination
%a coarse powder and one of the most affecting parameters in LPBF is the powder bed density packing. The lower is the relative density of powder bed are accompanied with an higher volume fraction of pores within the powder bed. This consequently makes it rather challenging for the molten material to fill all of the interstices due to the rapid solidification nature of the LPBF process.
